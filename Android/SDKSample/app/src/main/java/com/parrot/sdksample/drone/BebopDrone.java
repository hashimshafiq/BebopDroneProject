...
public class BebopDrone {
    ...
    public interface Listener {
        void onCommandReceived(ARDeviceController deviceController, ARCONTROLLER_DICTIONARY_KEY_ENUM commandKey, ARControllerDictionary elementDictionary);
    ...
    private void AltitudeChanged(double altitude )
    {
        List<Listener> listenersCpy = new ArrayList<>(mListeners);
        for (Listener listener : listenersCpy) {
